...
public class Interface_Parameters_B_K_M extends javax.swing.JFrame {

    Parameters_B_K_M b_K_Parameter;
    public Interface_Parameters_B_K_M(Parameters_B_K_M bKmeans) {
        this.b_K_Parameter=bKmeans;
    ...
    private String[] getJList(){
        String[] string = new String[b_K_Parameter.getKs().size()];
        for (int i = 0; i < b_K_Parameter.getKs().size(); i++) {
            string[i] = b_K_Parameter.getKs().get(i).toString();
        }
        return string;
    }
    ...
    private void bOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bOkActionPerformed
        ...
        if(rAutomatic.isSelected()){
            b_K_Parameter.setIncrementK(Integer.parseInt(tIncrement.getText()));
            b_K_Parameter.setAutoIncrementK(true);
        }else{
            b_K_Parameter.setAutoIncrementK(false);
            b_K_Parameter.setKs(ks);
        }
        b_K_Parameter.setMinimumCohesion(Double.parseDouble(tCohesion.getText()));
        b_K_Parameter.setMaxIteration(Integer.parseInt(tMaxIterations.getText()));
        this.dispose();
